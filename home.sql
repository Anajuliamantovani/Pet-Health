...
-- Adicionei o endereço de cobrança para caso o cliente necessite.
-- Pode não se encaixar no projeto, e vai ser discutido posteriormente. (tiallysson@proton.me)
...
-- Modifiquei o local dessas tabelas pois iriam apresentar problemas posteriormente
-- Ainda irá ser analisado posteriormente (tiallysson@proton.me)
